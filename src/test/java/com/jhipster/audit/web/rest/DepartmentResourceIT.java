...
import com.jhipster.audit.domain.Department;
import com.jhipster.audit.repository.DepartmentRepository;
...
class DepartmentResourceIT {
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).departmentId(UPDATED_DEPARTMENT_ID).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentId(UPDATED_DEPARTMENT_ID);
