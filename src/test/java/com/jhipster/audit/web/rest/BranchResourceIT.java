...
class BranchResourceIT {
    ...
    public static Branch createEntity() {
        Branch branch = new Branch().branchName(DEFAULT_BRANCH_NAME).branchId(DEFAULT_BRANCH_ID).description(DEFAULT_DESCRIPTION);
        return branch;
    }
    ...
    public static Branch createUpdatedEntity() {
        Branch branch = new Branch().branchName(UPDATED_BRANCH_NAME).branchId(UPDATED_BRANCH_ID).description(UPDATED_DESCRIPTION);
        return branch;
    }
    ...
    void putExistingBranch() throws Exception {
        ...
        updatedBranch.branchName(UPDATED_BRANCH_NAME).branchId(UPDATED_BRANCH_ID).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateBranchWithPatch() throws Exception {
        ...
        partialUpdatedBranch.branchId(UPDATED_BRANCH_ID).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateBranchWithPatch() throws Exception {
        ...
        partialUpdatedBranch.branchName(UPDATED_BRANCH_NAME).branchId(UPDATED_BRANCH_ID).description(UPDATED_DESCRIPTION);
