...
type DivisionFormGroupContent = {
  ...
  divisionId: FormControl<IDivision['divisionId']>;
  divisionName: FormControl<IDivision['divisionName']>;
  userproifle: FormControl<IDivision['userproifle']>;
  department: FormControl<IDivision['department']>;
};
...
export class DivisionFormService {
  createDivisionFormGroup(division: DivisionFormGroupInput = { id: null }): DivisionFormGroup {
    ...
    return new FormGroup<DivisionFormGroupContent>({
      ...
      divisionId: new FormControl(divisionRawValue.divisionId),
      divisionName: new FormControl(divisionRawValue.divisionName),
      userproifle: new FormControl(divisionRawValue.userproifle),
      department: new FormControl(divisionRawValue.department),
    });
  }
