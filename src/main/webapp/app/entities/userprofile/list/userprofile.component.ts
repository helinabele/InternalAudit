...
import { EntityArrayResponseType, UserprofileService } from '../service/userprofile.service';
...
export class UserprofileComponent implements OnInit {
  ...
  trackId = (_index: number, item: IUserprofile): string => this.userprofileService.getUserprofileIdentifier(item);
