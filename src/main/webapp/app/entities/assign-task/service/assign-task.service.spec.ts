...
const requireRestSample: RestAssignTask = {
  ...
  taskAssignmentDate: sampleWithRequiredData.taskAssignmentDate?.format(DATE_FORMAT),
  taskStartDate: sampleWithRequiredData.taskStartDate?.format(DATE_FORMAT),
  taskDueDate: sampleWithRequiredData.taskDueDate?.format(DATE_FORMAT),
};
