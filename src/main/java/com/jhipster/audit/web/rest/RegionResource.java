...
/**
 * REST controller for managing {@link com.jhipster.audit.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
     ...
     */
    @GetMapping("/regions")
    public List<Region> getAllRegions(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
